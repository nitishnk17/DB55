...
impl PartialOrd for Data {
    fn partial_cmp(&self, other: &Self) -> Option<std::cmp::Ordering> {
        match (self, other) {
            ...
            // Cross-type numeric: promote to the larger type
            ...
            (Self::Int64(l), Self::Float32(r)) => (*l as f32).partial_cmp(r),
            (Self::Float32(l), Self::Int64(r)) => l.partial_cmp(&(*r as f32)),
            _ => None,
        }
    }
}
...
impl PartialEq for Data {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (Self::Float32(l), Self::Float64(r)) => (*l as f64) == *r,
            (Self::Float64(l), Self::Float32(r)) => *l == (*r as f64),
            ...
            (Self::Int32(l), Self::Float32(r)) => (*l as f32) == *r,
            (Self::Float32(l), Self::Int32(r)) => *l == (*r as f32),
            (Self::Int64(l), Self::Float32(r)) => (*l as f32) == *r,
            (Self::Float32(l), Self::Int64(r)) => *l == (*r as f32),
            _ => false,
        }
    }
}
